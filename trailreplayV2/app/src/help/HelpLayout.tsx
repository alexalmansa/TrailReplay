      ...
      <header className="sticky top-0 z-20 border-b border-[var(--evergreen)]/10 bg-[var(--canvas)]/88 text-[var(--evergreen)] backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
          ...
          <div className="hidden items-center gap-2 rounded-full border border-[var(--evergreen)]/10 bg-white/80 px-2 py-1 md:flex">
            <HeaderChip href="/app/tutorial.html" icon={<BookOpen className="h-3.5 w-3.5" />} label="Tutorial" />
            <HeaderChip href="/app/gpx-download-guide.html" icon={<Download className="h-3.5 w-3.5" />} label="GPX guide" />
          </div>
          <div className="flex items-center gap-3">
            <img src="/app/media/images/simplelogo.png" alt="TrailReplay" className="h-9 w-9 rounded-md bg-white p-1 shadow-sm" />
