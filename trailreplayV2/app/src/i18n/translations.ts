export const translations = {
  en: {
    ...
    sidebar: {
      ...
      footerSubtitle: 'GPX & KML Visualization v2.0',
    ...
    media: {
      ...
      manualPlacementTitle: 'Photo GPS does not match the route',
      manualPlacementHint: 'Click a point on the map and TrailReplay will place the image on the nearest point of the track.',
      manualPlacementQueuedSingle: '1 image needs manual placement. Click the map to place it.',
      manualPlacementQueuedMultiple: '{count} images need manual placement. Click the map to place them.',
  ...
  es: {
    ...
    sidebar: {
      ...
      footerTitle: 'Trail Replay',
      footerSubtitle: 'Visualización GPX & KML v2.0',
    ...
    media: {
      ...
      manualPlacementTitle: 'El GPS de la foto no coincide con la ruta',
      manualPlacementHint: 'Haz clic en un punto del mapa y TrailReplay colocará la imagen en el punto más cercano del track.',
      manualPlacementQueuedSingle: '1 imagen necesita colocación manual. Haz clic en el mapa para ubicarla.',
      manualPlacementQueuedMultiple: '{count} imágenes necesitan colocación manual. Haz clic en el mapa para ubicarlas.',
  ...
  ca: {
    ...
    sidebar: {
      ...
      footerTitle: 'Trail Replay',
      footerSubtitle: 'Visualització GPX & KML v2.0',
    ...
    media: {
      ...
      manualPlacementTitle: 'El GPS de la foto no encaixa amb la ruta',
      manualPlacementHint: 'Fes clic en un punt del mapa i TrailReplay col·locarà la imatge al punt més proper del track.',
      manualPlacementQueuedSingle: '1 imatge necessita col·locació manual. Fes clic al mapa per ubicar-la.',
      manualPlacementQueuedMultiple: '{count} imatges necessiten col·locació manual. Fes clic al mapa per ubicar-les.',
