export const es = {
  ...
  export: {
    ...
    statsOverlay: 'Panel de estadísticas',
    statsOverlayTitle: 'Panel de estadísticas',
    elevationProfile: 'Gráfico de perfil de elevación',
    fieldDistance: 'Distancia',
    fieldSpeed: 'Velocidad',
    fieldElevation: 'Desnivel',
    fieldElapsed: 'Tiempo',
    fieldHeartRate: 'Frecuencia cardíaca',
    fieldHeartRateDisabledHint: 'Este track no tiene datos de frecuencia cardíaca.',
