export const ca = {
  ...
  export: {
    ...
    statsOverlay: 'Superposició d\'estadístiques',
    statsOverlayTitle: 'Superposició d\'estadístiques',
    elevationProfile: 'Gràfic del perfil d\'elevació',
    fieldDistance: 'Distància',
    fieldSpeed: 'Velocitat',
    fieldElevation: 'Desnivell',
    fieldElapsed: 'Temps',
    fieldHeartRate: 'Freqüència cardíaca',
    fieldHeartRateDisabledHint: 'Aquest track no té dades de freqüència cardíaca.',
    overlayPosition: 'Posició de l\'overlay',
