export const en = {
  ...
  media: {
    ...
    manualPlacementHintMissingGps: 'This image has no usable GPS metadata and no timestamp-based placement was available. Click the map to place it on the nearest point of the route.',
    manualPlacementHintRouteMismatch: 'The image has GPS metadata, but it does not match the loaded route closely enough. Click the map to place it on the nearest point of the route.',
    manualPlacementHintNoTimedRoute: 'The image has a timestamp, but the loaded GPX does not include enough time data to place it automatically. Click the map to place it on the nearest point of the route.',
    manualPlacementHintTimestampOutOfRange: 'The image has a timestamp, but it falls outside the loaded route time range. Click the map to place it on the nearest point of the route.',
