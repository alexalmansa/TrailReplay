...
const PINHEAD_PATHS: Record<string, string> = {
  ...
  town: 'M12.64 4H11V2.36c0-.2-.16-.36-.36-.36h-.28c-.2 0-.36.16-.36.36V4H8.36c-.2 0-.36.16-.36.36V10H4.36c-.2 0-.36.16-.36.36v2.28c0 .2.16.36.36.36h8.28c.2 0 .36-.16.36-.36V4.36c0-.2-.16-.36-.36-.36M6 12H5v-1h1zm2 0H7v-1h1zm2 0H9v-1h1zm0-2H9V9h1zm0-2H9V7h1zm0-2H9V5h1zm2 6h-1v-1h1zm0-2h-1V9h1zm0-2h-1V7h1zm0-2h-1V5h1zM7 2.36c0-.2-.16-.36-.36-.36H4.36c-.2 0-.36.16-.36.36V4H2.36c-.2 0-.36.16-.36.36v8.29c0 .19.16.35.35.35H3V9h4zM4 8H3V7h1zm0-2H3V5h1zm2 2H5V7h1zm0-2H5V5h1zm0-2H5V3h1z',
